...
// TODO: move vars to a top level config file or .env
const title = 'Project Open Plex'
const description =
  'An open design project for affordable backyard garden studio shed for remote work.'
...
export const base_helmet: IHelmet = {
  title,
  description,
  titleTemplate: 'project-open-plex',
